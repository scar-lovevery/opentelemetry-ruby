...
describe OpenTelemetry::SDK::Trace::Span do
  ...
  let(:span) do
    Span.new(context, Context.empty, OpenTelemetry::Trace::Span::INVALID, 'name', SpanKind::INTERNAL, nil, trace_config,
  ...
  describe '#initialize' do
    ...
    it 'calls the span processor #on_start callback' do
      ...
      span = Span.new(context, Context.empty, OpenTelemetry::Trace::Span::INVALID, 'name', SpanKind::INTERNAL, nil, trace_config,
                      mock_span_processor, nil, nil, Time.now, nil, nil)
